...
export default class SLevel8 extends React.Component {
    ...
    onSystemLevelChange = () => {
        this.props.setPhysicalExercise('standing', true)
        this.props.onSystemLevelChange(this.props.systemLevel + 1)
    }
            ...
            [
                {
                    text: 'ใช่', onPress: () => {
                        ...
                        this.props.setPhysicalExercise('standing', false)
                    }
                },
        ...
        return (
            <View>
                <View style={{ alignItems: 'center' }}>
                    <Image source={require('../../assets/images/activities/standing.png')} style={_styles.image} />
                </View>
    ...
    render() {
        ...
        return (
            <View style={_styles.container}>
                ...
                <Text style={_styles.topic}>ยืนข้างเตียง</Text>

...
export default class Step1Post extends React.Component {
    ...
    render() {
        ...
        return (
            ...
            //Display only 1 borg face and will change depending on slider's value
            // <View style={styles.container}>
            //     <ScrollView style={{ flex: 1 }}>
            //         <Text style={[styles.text, {fontWeight: 'bold'}]}>โปรดเลือกระดับความเหนื่อย</Text>
            ...
            //                 </View>
            //                 <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
            //                     <Text style={styles.sliderText}>Borg scale: {this.props.borg ? this.props.borg : this.state.borg}</Text>
            //                 </View>
            //             </View>

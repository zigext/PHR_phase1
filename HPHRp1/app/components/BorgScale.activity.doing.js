...
import { View, Text, StyleSheet, TouchableHighlight, Image, ScrollView, ToastAndroid } from 'react-native'
import { Icon, Slider } from 'react-native-elements'
import common from '../styles/common'

export default class BorgScale extends React.Component {
    constructor(props) {
        super(props)
        this.state = {
            borg: 6,
    ...
    onForward = () => {
        if (this.state.borg >= 12)
            ToastAndroid.showWithGravity('ระดับความเหนื่อยถึงเกณฑ์ที่กำหนด ควรหยุดทำกิจกรรม', ToastAndroid.LONG, ToastAndroid.CENTER)
        ...
        return (
            <View style={styles.container}>
                <ScrollView style={{ flex: 1 }}>
                    ...
                    <Text style={[styles.sliderText, { marginHorizontal: 150 }]}>Borg scale: {this.props.borg ? this.props.borg : this.state.borg}</Text>

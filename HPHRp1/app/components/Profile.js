                ...
                <View style={_styles.container}>
                    ...
                    <ScrollView>
                        ...
                        <View style={_styles.contentContainer}>
                            ...
                            {/*is_smoking is boolean or string*/}
                            ...
                            <Text style={_styles.text}>วันที่ผ่าตัดหัวใจ : {this.props.profile.surgery_date? this.formatDate(this.props.profile.surgery_date)  : '-'}</Text>

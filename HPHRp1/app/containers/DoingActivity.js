...
class DoingActivity extends React.Component {
    ...
    renderBody = () => {
        switch (this.state.systemLevel) {
            ...
            //Stationary marching
            case 9:
                return <SLevel9 exception={this.props.exception.ac9} finalSystemLevel={this.props.exception.finalSystemLevel} resultForPassedOn={this.state.resultForPassedOn} systemLevel={this.state.systemLevel} activityLevel={this.state.activityLevel} onSystemLevelChange={this.onSystemLevelChange} doingLevel={this.props.doingLevel} onDoingActivityDone={this.props.onDoingActivityDone} setTimeStop={this.props.setTimeStop} setDuration={this.props.setDuration} onDataChange={this.onDataChange} dataStore={dataStore} setPhysicalExercise={this.setPhysicalExercise} physicalExercise={physicalExercise} breathingExercise={breathingExercise} completedAllBreathing={this.state.completedAllBreathing} completedAllPhysical={this.state.completedAllPhysical} />
            //Walking
            ...
            case 11:
                return <SLevel11 exception={this.props.exception.ac11} finalSystemLevel={this.props.exception.finalSystemLevel} resultForPassedOn={this.state.resultForPassedOn} systemLevel={this.state.systemLevel} activityLevel={this.state.activityLevel} onSystemLevelChange={this.onSystemLevelChange} onActivityLevelChange={this.onActivityLevelChange} doingLevel={this.props.doingLevel} onDoingActivityDone={this.props.onDoingActivityDone} setTimeStop={this.props.setTimeStop} setDuration={this.props.setDuration} onDataChange={this.onDataChange} dataStore={dataStore} setPhysicalExercise={this.setPhysicalExercise} physicalExercise={physicalExercise} breathingExercise={breathingExercise} completedAllBreathing={this.state.completedAllBreathing} completedAllPhysical={this.state.completedAllPhysical} onAllPhysicalCompleted={this.onAllPhysicalCompleted} />
            //Stair walking
            //doingLevel is level that the patient that doing , read from server
            case 12:
                return <SLevel12 exception={this.props.exception.ac12} finalSystemLevel={this.props.exception.finalSystemLevel} resultForPassedOn={this.state.resultForPassedOn} systemLevel={this.state.systemLevel} activityLevel={this.state.activityLevel} onSystemLevelChange={this.onSystemLevelChange} onActivityLevelChange={this.onActivityLevelChange} doingLevel={this.props.doingLevel} onDoingActivityDone={this.props.onDoingActivityDone} setTimeStop={this.props.setTimeStop} setDuration={this.props.setDuration} onDataChange={this.onDataChange} dataStore={dataStore} setPhysicalExercise={this.setPhysicalExercise} physicalExercise={physicalExercise} breathingExercise={breathingExercise} completedAllBreathing={this.state.completedAllBreathing} completedAllPhysical={this.state.completedAllPhysical} onAllPhysicalCompleted={this.onAllPhysicalCompleted} />
            //doingLevel is level that the patient that doing , read from server
            // case 13:

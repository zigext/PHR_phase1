...
class DoingActivity extends React.Component {
    ...
    renderBody = () => {
        switch (this.state.systemLevel) {
            ...
            //Arms exercising
            case 4:
                return <SLevel4 exception={this.props.exception.ac4} finalSystemLevel={this.props.exception.finalSystemLevel} resultForPassedOn={this.state.resultForPassedOn} systemLevel={this.state.systemLevel} onSystemLevelChange={this.onSystemLevelChange} activityLevel={this.state.activityLevel} onActivityLevelChange={this.onActivityLevelChange} onDoingActivityDone={this.props.onDoingActivityDone} setTimeStop={this.props.setTimeStop} setDuration={this.props.setDuration} onDataChange={this.onDataChange} dataStore={dataStore} setPhysicalExercise={this.setPhysicalExercise} physicalExercise={physicalExercise} breathingExercise={breathingExercise} lastBreathingLevel={this.state.lastBreathingLevel} setLastPhysicalLevel={this.setLastPhysicalLevel} completedAllPhysical={this.state.completedAllPhysical} completedAllBreathing={this.state.completedAllBreathing} onAllPhysicalCompleted={this.onAllPhysicalCompleted}/>
